...
/**
 * Класс "Сообщение: Игра: ответ"
 * @author iMacAverage
 */
public class BCMsgGameResponse extends BCMsg {
     ...
     */
    public BCMsgGameResponse(BCTable bcTable, String numberA, String numberB) {
     ...
     * @param numberB загаданное число игрока игрока Б
     */
    public BCMsgGameResponse(BCTable bcTable, String numberB) {
        this.bcTable = bcTable;
        this.numberA = null;
        this.numberB = numberB;
    }
